...
CREATE TABLE Orders (
  ...
  CardExpires       VARCHAR(10)    NOT NULL,
   FOREIGN KEY (CustomerID) REFERENCES Customers(CustomerID),
...
(1000, 199, '49.99', '0.00', '1'),
(2000, 299, '29.99', '5.00', '2'),
(3000, 399, '99.99', '10.00', '1'),
(4000, 499, '79.99', '0.00', '1'),
(5000, 599, '199.99', '15.00', '2'),
(6000, 699, '149.99', '0.00', '1'),
(7000, 799, '399.99', '20.00', '1'),
(8000, 899, '299.99', '0.00', '1'),
(9000, 999, '599.99', '30.00', '1'),
(10000, 1999, '499.99', '0.00', '1');
