...
-- MODULARIDAD  
/*
Dividir un sistema grande y compelfo en componenetes mas pequeños. 
*/

create database Tienda_Modularidad;
USE Tienda_Modularidad;
...
CREATE PROCEDURE RegistrarCliente(IN nombre VARCHAR(255), 
